...
const userSchema = new mongoose.Schema({
  ...
  email: {
    ...
    unique: true,
    lowercase: true,
    validater: [validator.isEmail, "plz provide a valid email"],
  },
  photo: { type: String, default: "default.jpg" },
  password: {
    type: "string",
    required: [true, "plz tell us your password"],
  ...
  passwordConfirm: {
    ...
    validate: {
      //this olny work on  CTREATE and SAVE!!!
...
userSchema.methods.secondCreatePasswordResetToken = function () {
  const resetToken = crypto.randomBytes(32).toString("hex");
